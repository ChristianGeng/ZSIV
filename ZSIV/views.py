...
#        print("debug punkt .. ")
    ...
    def post(self, request, *args, **kwargs):
        ...
        #return render_to_response('ZSIV/index.html') # zuruecl nach hause
        return HttpResponseRedirect(reverse('ZSIV:queue'))



    """
    hier sollen die Emails geschickt werden
    wie packt man das an? 
    Momentan habe ich ein Template, welches lediglich rendert
    
    Im template gibt es eine Dreifach-loop.
    Pro Mitarbeiter werden dann seine Supscriptions hergeholt: ma.Subscriptions.all
    Pro Subcription werden dann die summaries hergeholt: 
    subscription.summaries_set.values
    Momentan werden noch nicht mal die bereits gefilterten Daten 
    
    Brauche ich eine Form? Eigentlich nein, oder?
    Unless you’re planning to build websites and applications that do nothing but publish content, 
    and don’t accept input from your visitors, you’re going to need to understand and use forms.
    ...
    Many to many and form: GUTT GUTT
